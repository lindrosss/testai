            ...
            <Section title="Что делает приложение">
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>
                  ...
                  которые попадают сюда <span className="font-medium">из бота</span>,
                  когда клиент просит “перезвоните” и оставляет номер. Для заявок
                  можно вести статусы обработки.
                </li>
                <li>
